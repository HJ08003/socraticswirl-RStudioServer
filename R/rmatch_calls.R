...
#' @examples
#' \dontrun{rmatch_calls(quote(help("print")))}
#' \dontrun{# S3 method with atomic first argument
#' rmatch_calls(quote(seq(0, 1, by=.5)))}
#' \dontrun{# S3 method with non-atomic first argument, eval_for_class = FALSE (default)
#' rmatch_calls(quote(seq(as.Date("2014-02-01"), as.Date("2014-03-01"))))}
#' \dontrun{# S3 method with non-atomic first argument, eval_for_class = TRUE
